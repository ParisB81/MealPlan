    ...
    <div className="min-h-screen bg-page-bg">
      <div className="container mx-auto px-4 py-4 md:py-8 max-w-5xl">
        ...
        <header className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-text-primary mb-3">Ingredient Refinement</h1>
        ...
        {/* Scope Section */}
        <Card className="mb-8">
          <h2 className="text-2xl font-semibold text-text-primary mb-4">Scope</h2>
        ...
        <Card className="mb-8">
          <h2 className="text-2xl font-semibold text-text-primary mb-4">Refinement Actions</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              <h3 className="text-lg font-semibold text-text-primary">1. Fix Invalid Units</h3>
            ...
            <div className="border-l-4 border-green-500 pl-4">
              <h3 className="text-lg font-semibold text-text-primary">2. Merge Plural Forms</h3>
              <p className="text-text-secondary text-sm mb-2">
            ...
            <div className="border-l-4 border-yellow-500 pl-4">
              <h3 className="text-lg font-semibold text-text-primary">3. Remove Noise from Names</h3>
              <p className="text-text-secondary text-sm mb-2">
              ...
              <ul className="list-disc list-inside text-text-secondary mt-2 ml-4 space-y-1">
            ...
            <div className="border-l-4 border-purple-500 pl-4">
              <h3 className="text-lg font-semibold text-text-primary">4. Resolve Vague Ingredient Names</h3>
              <p className="text-text-secondary text-sm mb-2">
            ...
            <div className="border-l-4 border-red-500 pl-4">
              <h3 className="text-lg font-semibold text-text-primary">5. Translate Non-English Ingredients</h3>
              <p className="text-text-secondary text-sm mb-2">
            ...
            <div className="border-l-4 border-orange-500 pl-4">
              <h3 className="text-lg font-semibold text-text-primary">6. Merge Duplicate Ingredients</h3>
              <p className="text-text-secondary text-sm mb-2">
            ...
            <div className="border-l-4 border-gray-500 pl-4">
              <h3 className="text-lg font-semibold text-text-primary">7. Verify Recipe Integrity</h3>
              <p className="text-text-secondary text-sm mb-2">
        ...
        {/* Prompt Section */}
        <Card className="mb-8">
          <h2 className="text-2xl font-semibold text-text-primary mb-4">AI Prompt for Refinement</h2>
          <p className="text-text-secondary mb-4">
            Use the following prompt with Claude to perform ingredient refinement after adding new recipes:
          </p>
          <div className="bg-hover-bg rounded-lg p-4 font-mono text-sm text-text-primary whitespace-pre-wrap">
...
Report a summary of all changes made.`}
        ...
        {/* Technical Notes */}
        <Card>
          <h2 className="text-2xl font-semibold text-text-primary mb-4">Technical Notes</h2>
          <div className="space-y-4 text-text-primary">
            <div>
              <h3 className="font-semibold text-text-primary">Database Constraints</h3>
              <p>
                The <code className="bg-hover-bg px-1 rounded">Ingredient.name</code> field has a unique constraint.
            ...
            <div>
              <h3 className="font-semibold text-text-primary">Foreign Key References</h3>
              <p>
                Ingredients are referenced by two tables:
              </p>
              <ul className="list-disc list-inside ml-4 mt-2">
                <li><code className="bg-hover-bg px-1 rounded">RecipeIngredient</code> — links ingredients to recipes</li>
                <li><code className="bg-hover-bg px-1 rounded">ShoppingListItem</code> — links ingredients to shopping lists</li>
              </ul>
              <p className="mt-2">
            ...
            <div>
              <h3 className="font-semibold text-text-primary">Quantity Combining</h3>
              <p>
            ...
            <div>
              <h3 className="font-semibold text-text-primary">Scripts Location</h3>
              <p>
                Refinement scripts are stored in <code className="bg-hover-bg px-1 rounded">scripts/</code> at the project root.
                Key scripts include:
              </p>
              <ul className="list-disc list-inside ml-4 mt-2">
                <li><code className="bg-hover-bg px-1 rounded">find-invalid-units.ts</code> — exports invalid units to Excel</li>
                <li><code className="bg-hover-bg px-1 rounded">fix-invalid-units.ts</code> — applies unit corrections</li>
                <li><code className="bg-hover-bg px-1 rounded">fix-ingredient-names.ts</code> — general ingredient cleanup</li>
                <li><code className="bg-hover-bg px-1 rounded">fix-vague-ingredients.ts</code> — context-specific vague name fixes</li>
                <li><code className="bg-hover-bg px-1 rounded">check-recipe-ingredients.ts</code> — verification script</li>
              </ul>
            </div>
          </div>
        </Card>
