    ...
    <div className="min-h-screen bg-page-bg">
      <div className="container mx-auto px-4 py-4 md:py-8">
        ...
        <header className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-text-primary mb-3">Developer Tools</h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <Link to="/developer/assets">
            <Card hoverable className="h-full">
              ...
              <h2 className="text-2xl font-semibold text-text-primary mb-2">Assets Library</h2>
          ...
          <Link to="/developer/tags">
            <Card hoverable className="h-full">
              ...
              <h2 className="text-2xl font-semibold text-text-primary mb-2">Tag Manager</h2>
              <p className="text-text-secondary">
          ...
          <Link to="/developer/ingredients">
            <Card hoverable className="h-full">
              <div className="text-4xl mb-3">🧹</div>
              <h2 className="text-2xl font-semibold text-text-primary mb-2">Ingredient Refinement</h2>
              <p className="text-text-secondary">
